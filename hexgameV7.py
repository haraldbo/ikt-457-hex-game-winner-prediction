...
import argparse
import random
from utils import load_dataset, create_graph, display_as_graph, create_possible_neighbour_lookup
import networkx
...
def populate_graphs(X: np.ndarray, graphs: Graphs, board_size):
    neighbour_lookup = create_possible_neighbour_lookup(board_size)
